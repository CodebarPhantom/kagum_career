...
<head>
	...
	<title>Kagum Hotels Career Recruitment </title>
	...
	<div class="page-content cover-image-login">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<!-- Login card -->
				<form class="login-form" action="<?php echo base_url('hrlogin/auth');?>" method="post">
					<div class="card mb-0">
						<div class="card-body">
							<div class="text-center mb-3">
								<img src="<?php echo base_url();?>assets/backend/global_assets/images/recruit.png" class="responsive " height="85" width="165">
								
								<!--<i class="icon-users4 icon-2x text-slate-300 border-slate-300 border-3 rounded-round p-3 mb-3 mt-1"></i>-->
								<h5 class="mb-0">Kagum Hotels Career Recruitment</h5>
